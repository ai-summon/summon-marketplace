...
**summon-marketplace** provides a collection of hand-picked, production-ready plugins that supercharge your AI-powered development workflow. Whether you're using Claude Code or GitHub Copilot CLI, these plugins extend capabilities with powerful features for brainstorming, planning, testing, debugging, and code review.
...
```bash
# Claude Code
claude plugin marketplace browse summon-marketplace

# Copilot CLI
copilot plugin marketplace browse summon-marketplace
```

**Refresh the marketplace catalog** (picks up newly added or updated plugins):
```bash
# Claude Code
claude plugin marketplace update summon-marketplace
...
```bash
copilot plugin marketplace remove summon-marketplace --force
```
